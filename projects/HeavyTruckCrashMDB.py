...
#conn = pyodbc.connect(r'Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=/lss/research/itrns-otohpc/CrashTools/HeavyTruckCrash/working.mdb;')
#cursor = conn.cursor()

conn_str = (
    r'DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};'
    r'DBQ=/lss/research/itrns-otohpc/CrashTools/HeavyTruckCrash/working.mdb;'
    )
