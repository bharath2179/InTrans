...
inputfile = "D:\\crash\\HeavyTruckCrash\\working.mdb"
outputfile = "D:\\crash\\HeavyTruckCrash\\Output.csv"
outputcl = "D:\\crash\\HeavyTruckCrash\\CRASH_LEVEL.csv"
outputvl = "D:\\crash\\HeavyTruckCrash\\VEHICLE_LEVEL.csv"
outputpl = "D:\\crash\\HeavyTruckCrash\\PERSON_LEVEL.csv"
...
#conn = pyodbc.connect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=%s;"%inputfile)
#conn = pyodbc.connect("Driver={Microsoft Access Driver (*.mdb, *.accdb)};" + "Dbq=C:\Users\davami\Box\CrashTools\HeavyTruckCrash\working.mdb;")
#curs = conn.cursor()

#conn = pyodbc.connect(r'Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=D:\\crash\\HeavyTruckCrash\\working.mdb;')
#cursor = conn.cursor()

#conn_str = (
 #   r'DRIVER={Microsoft Access Driver (*.mdb)};'
  #  r'DBQ=D:\crash\HeavyTruckCrash\working.mdb;'
   # )
