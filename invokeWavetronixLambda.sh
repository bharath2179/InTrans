#!/bin/sh
#Invokes the Inrix Lambda function in AWS with name my-sourcecode-function
...
aws lambda invoke --function-name my-sourcecode-function --payload '{"key1": "value1", "key2": "value2", "key3": "value3"}' output.txt --profile testadmin
