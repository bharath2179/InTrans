#!/bin/sh
#Invokes AWS lambda Inrix function
...
aws lambda invoke --function-name inrixlamdbafunct --payload '{"key1": "value1", "key2": "value2", "key3": "value3"}' output.txt --profile testadmin
